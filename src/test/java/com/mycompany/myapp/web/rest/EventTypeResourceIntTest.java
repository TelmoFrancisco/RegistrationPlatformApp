...
public class EventTypeResourceIntTest {
    ...
    public void setup() {
        ...
        EventTypeResource eventTypeResource = new EventTypeResource(eventTypeService);
    ...
    public void createEventType() throws Exception {
        ...
        assertThat(testEventType.getPrice()).isEqualTo(DEFAULT_PRICE);
    }
    ...
    public void updateEventType() throws Exception {
        ...
        assertThat(testEventType.getPrice()).isEqualTo(UPDATED_PRICE);
    }
